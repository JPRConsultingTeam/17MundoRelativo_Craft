        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h2>Bienvenido <small>Tipos de Incidencias</small></h2>


              
      <h3 style="color: #3c8dbc;">Ingresar Nuevos Tipos de  Incidencias</h3>
      
        <form action="TiposIncidencias .php" method="post">



  <div class="col-md-4">
  <label style="font-family: Arial;">Nombre Incidencia:</label>
...
include("../Funciones/RegisTipoIncidencias.php");
?>
