        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              ...
              <p>Para la carga masiva de empleados es necesario <a onclick="window.location.href='xls/Reportes.xls'" class="ng-binding">descargar el formato</a> y rellenar los campos. Es importante que todos los campos marcados como obligatorios sean llenados sin excepción para evitar errores.</p>
