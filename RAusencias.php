...
<form action="RegistroAusencia.php" method="post" enctype="multipart/form-data">
<div class="col-md-4">
   <?php
   include "Conexion.php";
...
<input type="text" class="form-control" name="ausencia" list="ausencia" required placeholder="Ejemplo: Enfermedad">
<datalist id="ausencia">
...
<input type="date" name="fechainicio" class="form-control" required ><br><br>
</div>
...
<input type="date" name="fechafinal" class="form-control" required ><br><br>
  ...
  <div class="col-md-12">
  <a href="Incidencias.php"><button style="width: 100px;" class="btn btn-primary">Ver Ausencias</button></a>
  </div>
