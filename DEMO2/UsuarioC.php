...
<div class="content-wrapper">
  ...
  <input id="filtrar" type="text" class="form-control" placeholder="Ingresa El Nombre Buscar...">
      ...
      <!-- Fin de La Busqueda -->
  <br>
<a href="Registro/Usuarios.php"><button class="btn btn-primary">Registrar Usuario</button></a>
<a href="CargaMasiva.php"><button class="btn btn-danger">Carga Masiva</button></a>
<a href="Crud/CrudUsuarios.php"><button class="btn btn-primary">Ver Usuarios Normales</button></a>
<br><br>

<table class="table table-hover">
        <tbody class="buscar">
           <tr>
          <th>ID</th><th>Nombre</th><th>Dirección</th><th>Correo</th><th>Telefono</th><th>Fecha Alta</th><th>Estado</th><th>Función</th>
        </tr>     
        <?php
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          ...
          echo"<td>"; 
             ...
             echo"<a class='btn btn-primary' style='width:100px;' href='modificar/ModificarUsuarioC.php?id=".$fila[0]."'>
            <span class='glyphicon glyphicon-pencil'></span> Editar</a> <br><br> ";   

          echo "<a class='btn btn-danger' style='width:100px;' href='PHP/EliminarUC.php?id=" .$fila[0] ."'><span class='glyphicon glyphicon-remove'></span> Desactivar</a>";   
          echo "</td>";
          echo "</tr>";
        }
        $resultado->close();
