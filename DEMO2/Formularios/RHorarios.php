...
<!-- Inicio  Caja 1-->
  ...
  <form action="RHorarios.php" method="post">
<div class="col-md-4">
  ...
  <div class="col-md-12">
  <a href="../Crud/Horarios.php"><button style="width: 100px;" class="btn btn-primary">Ver Horarios</button></a>
  </div>

<?php
include("../Funciones/RegisHorario.php");
?>
