...
<!-- Inicio  Caja 1-->
  ...
  <div class="row">
      ...
      <h3 style="color: #3c8dbc;">Datos De La Empresa</h3>
        ...
        <form action="REmpresas.php" method="post">
  <div class="col-md-4">
...
<option value="Otro país" /> 
  ...
  <div class="col-md-12">
 <button type="submit" class="btn btn-primary" name="btn-upload">Registrar Empresa</button><br><br>
  </div>
  </form>
...
<?php
include("../Funciones/RegisEmpresa.php");
?>
