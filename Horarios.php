        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3>Bienvenido <small>Nuevos Horarios</small></h3>
            
  <a href="RHorarios.php" class="btn btn-primary">Agregar un Horario</a>
<br><br>
<table class='table'>
        <tr>
          <th>Id</th><th>Dia</th><th>Tipo</th><th>Hora De Entrada</th><th>Hora De Comida</th><th>Regreso de Comida</th><th>Salida</th><th>Función</th>
        </tr>     
<?php
         ...
         echo "<td>$fila[0]</td><td>$fila[1]</td><td>$fila[2]</td><td>$fila[3]</td><td>$fila[4]</td><td>$fila[5]</td><td>$fila[6]</td>"; 
          echo"<td>";
            ...
            echo "<a data-toggle='modal' data-target='#editUsu' data-id='" .$fila[0] ."' data-nombre='" .$fila[1] ."' data-edad='" .$fila[2] ."' data-direccion='" .$fila[3] ."'</a>";
             ...
             echo"<a class='btn btn-primary' href='modificar/.php'><span class='glyphicon glyphicon-pencil'></span> Editar</a> "; 



          echo "<a class='btn btn-danger' href='PHP/EliminarH.php?idhora=" .$fila[0] ."'>
