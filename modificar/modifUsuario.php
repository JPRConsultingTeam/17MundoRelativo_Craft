...
$sql= "UPDATE usuarios SET nombre='$nombre', apellidop='$apellidop', apellidom='$apellidom',edad='$edad', genero='$genero', notelef='$notelef', correo='$correo', contrasena='$contrasena', fechanacimiento='$fechanacimiento', pais='$pais', estado='$estado', municipio='$municipio', calle='$calle', cp='$cp', idempresa='$idempresa', fechaalta='$fechaalta', fechabaja='$fechabaja', idgrupo='$idgrupo', noseguro='$noseguro', modchecar='$modchecar', idhora='$idhora', puesto='$puesto', contac1='$contac1', contac2='$contac2' WHERE idusuario='$idusuario'";
