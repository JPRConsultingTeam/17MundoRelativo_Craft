...
<!-- Inicio  Caja 1-->
  ...
  <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h2>Bienvenido <small>Modificar Grupo</small></h2>

              


      <h3 style="color: #3c8dbc;">Datos de Grupo</h3>
      ...
      <form action="ModificarGrupo.php?idgrupo=<?php echo $arreglo['idgrupo'];?>" method="post">


<div class="col-md-4">
  <label style="font-family: Arial;">Nombre:</label>
   <?php
  echo"<input type='text' name='nombre' class='form-control' name='entrada' required value='".$arreglo['nombre']."'>";
   ?>
  </div>
 ...
 <div class="col-md-4">
  ...
  <?php
  echo"<textarea  class='form-control' name='descripcion' required value='".$arreglo['descripcion']."'></textarea>";
  ?>
  </div>
 ...
 <div class="col-md-4">
  ...
  <?php
  echo"<input type='text' class='form-control' name='activo' list='activos' required value='".$arreglo['activo']."'>";
  ?>
  <datalist id="activos">
...
<div class="col-md-12">
 ...
 <br><br><br>
        ...
        <div class="col-md-12">
<a href="../Grupos.php"><button class="btn btn-primary">Ver Grupos</button></a>
</div>
...
$sql = "UPDATE grupo SET nombre='$nombre', descripcion='$descripcion', activo='$activo' WHERE idgrupo='$idgrupo'";
