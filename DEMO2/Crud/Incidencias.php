        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3>Bienvenido <small>Incidencias</small></h3>
            
  <a href="../Formularios/RIncidencias.php" class="btn btn-primary">Agregar una Incidencia</a>
   <a href="../Formularios/TiposIncidencias .php" class="btn btn-primary">Agregar un tipo de Incidencias</a>
<br><br>
<table class='table'>
        <tr>
     ...
     include("../Funciones/CRDincidencias.php");
?>
