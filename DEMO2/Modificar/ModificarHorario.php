...
<div class="col-md-4">
  ...
  <?php
  echo"<input type='text' class='form-control' name='dia' list='dias' required value='".$arreglo['dia']."'>";
  ?>
  <datalist id="dias">
...
<div class="col-md-12">
 ...
 <br><br><br>
        ...
        <div class="col-md-12">
<a href="../Crud/Horarios.php"><button class="btn btn-primary">Ver Horarios</button></a>
</div>
