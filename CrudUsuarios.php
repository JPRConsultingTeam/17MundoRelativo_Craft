...
<div class="content-wrapper">
  ...
  <input id="filtrar" type="text" class="form-control" placeholder="Ingresa El Nombre Buscar...">
      ...
      <!-- Fin de La Busqueda -->
  <br>
<a href="Usuarios.php"><button class="btn btn-primary">Registrar Usuario</button></a>
...
<table class="table table-hover">
        <tbody class="buscar">
           <tr>
          <th>ID</th><th>Nombre</th><th>Edad</th><th>Correo</th><th>Fecha De Nacimiento</th><th>Fecha Alta</th><th>Fecha Baja</th><th>Numero De Seguro</th><th>Puesto</th><th>Función</th>
        </tr>     
        <?php
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          echo "<tr>";
          echo "<td>$fila[0]</td><td>$fila[1] $fila[2] $fila[3]</td><td>$fila[4]</td><td>$fila[7]</td><td>$fila[9]</td><td>$fila[16]</td><td>$fila[17]</td><td>$fila[19]</td><td>$fila[22]</td>";  
          echo"<td>";           
             echo"<a class='btn btn-primary' style='width:100px;' href='modificar/ModificarUsuario.php?idusuario=".$fila[0]."'>

            <span class='glyphicon glyphicon-pencil'></span> Editar</a> <br><br> ";   

          echo "<a class='btn btn-danger' style='width:100px;' href='PHP/EliminarU.php?idusuario=" .$fila[0] ."'><span class='glyphicon glyphicon-remove'></span> Desactivar</a>";   
          echo "</td>";
          echo "</tr>";
        }
        $resultado->close();
