        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3>Bienvenido <small>Incicencias</small></h3>
            
  <a href="RIncidencias.php" class="btn btn-primary">Agregar una Incidencia</a>
<br><br>
<table class='table'>
        <tr>
          <th>ID</th><th>ID Del Usuario</th><th>Tipo De Incidencia</th><th>Fecha Inicial</th><th>Fecha Final</th><th>Documento</th><th>Función</th>
        </tr>     
        <?php
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          ...
          echo "<a data-toggle='modal' data-target='#editUsu' data-id='" .$fila[0] ."' data-nombre='" .$fila[1] ."' data-descripcion='" .$fila[2] ."' data-activo='" .$fila[3] ."'</a> ";  
            ...
            echo"<a class='btn btn-info' href='modificar/ModificarIncidencia.php?idincidencia=".$fila[0]."'>

            <span class='glyphicon glyphicon-pencil'></span> Editar</a> ";

          echo "<a class='btn btn-danger' href='PHP/EliminarI.php?idincidencia=" .$fila[0] ."'><span class='glyphicon glyphicon-remove'></span> Desactivar</a>"; 
