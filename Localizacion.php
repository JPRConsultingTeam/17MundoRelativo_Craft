...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="Administrador.php" class="logo">
      ...
      <span class="logo-lg"><b>WEB TIME</b></span>
    </a>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
                ...
                <h3>Bienvenido <small>Localización</small></h3>
                <br>
                <a href="LocalizacionR.php" class="btn btn-primary">Agregar una Empresa</a>
<br><br>
<table class='table'>
        <tr>
          <th>ID</th><th>Lugar</th><th>Dirección</th><th>Latitud</th><th>Longitud</th><th>Funcion</th>
        </tr>     
        <?php
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          echo "<tr>";
          echo "<td>$fila[0]</td><td>$fila[1]</td><td>$fila[3]</td><td>$fila[6]</td><td>$fila[7]</td>";  
          echo"<td>";           
          ...
          echo "<a class=
          'btn btn-danger' href='PHP/EliminarL.php?cod_Cliente=" .$fila[0] ."'><span class='glyphicon glyphicon-remove'></span> Desactivar</a>";   
          echo "</td>";
          echo "</tr>";
        }
        $resultado->close();
