...
<form action="RAusencias.php" method="post" enctype="multipart/form-data">
<div class="col-md-4">
   <?php
...
<textarea class="form-control" name="ausencia" required="" ></textarea>
</div>
...
include("../Funciones/RegisAusencia.php");
?>
