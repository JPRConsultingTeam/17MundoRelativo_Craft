        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3>Bienvenido <small>Grupos</small></h3>
            
  <a href="RGrupos.php" class="btn btn-primary">Agregar un Grupo</a>
<br><br>
<table class='table'>
        <tr>
          <th>ID</th><th>Nombre Del Grupo</th><th>Descripción</th><th>Activo</th><th>Función</th>
        </tr>     
        <?php
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          ...
          echo "<a class='btn btn-danger' style='width:100px;' href='PHP/EliminarG.php?idgrupo=" .$fila[0] ."'><span class='glyphicon glyphicon-remove'></span> Desactivar</a>";   
