...
<div class="content-wrapper">
  ...
  <a href="../Formularios/RGrupos.php" class="btn btn-primary">Agregar un Grupo</a>
  <a href="GpoInactivo.php" class="btn btn-danger">Inactivos</a>
<br><br>
<table class='table'>
        <tr>
          <th>ID</th><th>Nombre Del Grupo</th><th>Descripción</th><th>Función</th>
        </tr>     
        <?php
        include("../Funciones/CRDgrupos.php");
?>
</table>
