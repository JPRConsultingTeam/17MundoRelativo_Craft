...
<div class="content-wrapper">
  ...
  <a href="RAusencias.php" class="btn btn-primary">Agregar una Ausencia</a>
<br><br>
<table class='table'>
        <tr>
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          ...
          echo"<td>";           
            echo "<a data-toggle='modal' data-target='#editUsu' data-id='" .$fila[0] ."' data-nombre='" .$fila[1] ."' data-descripcion='" .$fila[2] ."' data-activo='" .$fila[3] ."' class='btn btn-primary'><span class='glyphicon glyphicon-pencil'></span> Editar</a> ";      
          echo "<a class='btn btn-danger' href='PHP/EliminarA.php?idausencia=" .$fila[0] ."'><span class='glyphicon glyphicon-remove'></span> Desactivar</a>";   
          echo "</td>";
          echo "</tr>";
        }
        $resultado->close();
