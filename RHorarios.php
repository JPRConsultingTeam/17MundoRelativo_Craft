...
<!-- Inicio  Caja 1-->
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h2>Bienvenido <small>Registro de Horarios</small></h2>

              
      <h3 style="color: #3c8dbc;">Datos Del Horario</h3>
      
  <form action="registroHorarios.php" method="post">
  ...
  <select class="form-control" required name="tipoturno">
  ...
  <input type="time" class="form-control" name="entrada" required><br>
  </div>

  <div class="col-md-4">
  <label style="font-family: Arial;">Hora de Comida:</label>
  <input type="time" class="form-control" name="salida" required><br>
  </div>

  <div class="col-md-4">
  <label style="font-family: Arial;">Hora de Regreso de Comida:</label>
  <input type="time" class="form-control" name="descanso" required><br>
  </div>

  <div class="col-md-4">
  <label style="font-family: Arial;">Hora de Salida:</label>
  <input type="time" class="form-control" name="regresoD" required><br>
  </div>

  <div class="col-md-12">
  <button type="submit" style="width: 100px;" class="btn btn-primary">Registrar</button><br><br>
  </div>
  </form>
        
  <div class="col-md-12">
  <a href="Horarios.php"><button style="width: 100px;" class="btn btn-primary">Ver Horarios</button></a>
  </div>
